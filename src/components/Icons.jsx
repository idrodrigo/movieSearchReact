...
export function SearchIcon () {
  return (
    <svg width="18px" height="18px" viewBox="-0.5 0 7 7" version="1.1" xmlns="http://www.w3.org/2000/svg">
